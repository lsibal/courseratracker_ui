...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white w-full h-auto flex flex-col md:flex-row md:h-screen">
        ...
        <div className="w-full md:w-1/2 p-6 md:p-10 flex items-center justify-center">
          <div className="w-full max-w-md">
            ...
            <h1 className="text-2xl font-bold mb-1 text-center md:text-left">Welcome back</h1>
            <p className="text-sm text-gray-500 mb-6 text-center md:text-left">Sign in to your account</p>
